...
if %_erl%==5 exit /b
if %_erl%==4 start https://github.com/CipherChris/idm & start https://ry0x7.github.io/idm & goto MainMenu
...
If not defined name set name=IDM CEO
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "no-reply@internetdownloadmanager.com"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v Serial /t REG_SZ /d "7Q4UH-6T3SI-4K7WH-NF6OX"" & call :_rcont
